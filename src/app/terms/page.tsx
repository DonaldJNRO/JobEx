export default function TermsPage() {
  return (
    <div className="min-h-screen bg-neutral-light dark:bg-neutral-dark py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-text-primary dark:text-white mb-8">Terms of Service</h1>
        <div className="prose dark:prose-invert max-w-none text-text-muted leading-relaxed space-y-6">
          <p><strong>Last updated:</strong> March 2026</p>
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">2. Use of Services</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">3. User Accounts</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">4. Bookings & Payments</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">5. Content & Conduct</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">6. Limitation of Liability</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">7. Contact</h2>
