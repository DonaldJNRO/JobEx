    ...
    <div className="min-h-screen bg-surface py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none text-text-muted leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-semibold text-ink">2. Use of Services</h2>
          ...
          <h2 className="text-xl font-semibold text-ink">3. User Accounts</h2>
          ...
          <h2 className="text-xl font-semibold text-ink">4. Bookings & Payments</h2>
          ...
          <h2 className="text-xl font-semibold text-ink">5. Content & Conduct</h2>
