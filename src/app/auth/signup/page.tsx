  ...
  return (
    <div className="min-h-screen bg-[#0f0f13] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#18181f] rounded-2xl border border-white/6 p-8 shadow-sm">
          {error && (
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-[#0f0f13] hover:bg-white/5 border border-white/8 py-3 rounded-xl text-sm font-medium transition-colors disabled:opacity-50"
          >
          ...
          <div className="flex items-center gap-3 my-5">
            <hr className="flex-1 border-black/5 border-white/10" />
