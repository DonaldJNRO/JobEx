  ...
  return (
    <div className="min-h-screen bg-neutral-light dark:bg-neutral-dark py-12">
      <div className="max-w-3xl mx-auto px-4">
        <h1 className="text-2xl font-bold text-text-primary dark:text-white mb-8">Saved Listings</h1>

        <div className="text-center py-20 bg-white dark:bg-card-dark rounded-2xl border border-black/5 dark:border-white/5">
          <Heart size={48} className="mx-auto text-text-muted/30 mb-4" />
          <h3 className="text-lg font-semibold text-text-primary dark:text-white">No saved listings</h3>
