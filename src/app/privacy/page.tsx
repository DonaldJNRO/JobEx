    ...
    <div className="min-h-screen bg-neutral-light dark:bg-neutral-dark py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose dark:prose-invert max-w-none text-text-muted leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">1. Information We Collect</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">2. How We Use Your Information</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">3. Data Sharing</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">4. Data Security</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">5. Your Rights</h2>
          ...
          <h2 className="text-xl font-semibold text-text-primary dark:text-white">6. Contact</h2>
