            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input type="text" required className="w-full px-4 py-3 rounded-xl bg-surface border border-line text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-ink mb-1.5">Email</label>
                  <input type="email" required className="w-full px-4 py-3 rounded-xl bg-surface border border-line text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea required rows={5} className="w-full px-4 py-3 rounded-xl bg-surface border border-line text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 resize-none" />
                </div>
                <button
                  type="submit"
                  disabled={sending}
